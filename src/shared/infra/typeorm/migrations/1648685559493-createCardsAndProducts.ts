...
export class createCardsAndProducts1648685559493 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tb_cards" ("id" uuid NOT NULL, "owner_name" character varying NOT NULL, "number" integer NOT NULL, "brand_id" character varying NOT NULL, "person_id" uuid NOT NULL, "security_code" character varying NOT NULL, "bandeira_id" uuid, CONSTRAINT "PK_6dea528d0de1b4ea34bcff34200" PRIMARY KEY ("id"))`);
